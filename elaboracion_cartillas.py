...
def main():
    ...
    FROM job200
    WHERE (job200.j_tech_spec LIKE '%se agregan%pliegos%cartilla%' OR job200.j_tech_spec LIKE '%genera%cartilla%')
    ...
    wsheet = gcon.open_by_url('https://docs.google.com/spreadsheets/d/1Sz9AlCWcLIBQtVWWWKWcDbX2EkuBTGKG0BEgX28H9-M')
